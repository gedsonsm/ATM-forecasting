...
# carregar dados
series = read_csv('BigStreet.csv', header=0, parse_dates=[0], index_col=0, squeeze=True)
n_test = -360
...
dadoSupervisionado = temporalParaSupervisionado(valorDif, 4)
...
print('Bigstreet Test RMSE: %.3f' % rmse)
# plot observado vs predito
pyplot.title('BigStreet')
